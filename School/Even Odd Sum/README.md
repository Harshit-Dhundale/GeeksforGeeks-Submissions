<h2><a href="https://www.geeksforgeeks.org/problems/even-odd-sum5450/1?page=5&difficulty=School&sortBy=submissions">Even Odd Sum</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array Arr[] of N integers.Find the sum of values of even and odd index positions separately.</span></p>
